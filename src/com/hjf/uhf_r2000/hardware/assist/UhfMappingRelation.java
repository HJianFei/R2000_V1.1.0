...
public class UhfMappingRelation {
	...
	/**
	 * baudrate 实际波特率 0 9600bps 1 19200 bps 2 38400 bps 5 57600 bps 6 115200 bps
	 */
	...
	/**
	 * 1、频点 + 频段 = 频率 2、最大频点和最小频点取值范围都是0~49
	 * 3、相同频点对应的最大频率和最小频率的值不一样，因为最大频段和最小频段不一样 4、频段采用 US band 最大频段规则：Bit7:0
	 * Bit6:0 最小频段规则：Bit7:1 Bit6:0 5、设置频段方法中的参数是频率
